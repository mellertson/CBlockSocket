...
CBlockingSocketException::CBlockingSocketException(const char* pchMessage)
{
...
//DEL int CBlockingSocket::Shutdown()
//DEL {
//DEL 	int i = 0;
//DEL 	return i;
//DEL }
...
/////////////////////////////////////////////////////////////////////////////////////
// Description: This constructor should only be used when throwing an exception 
//				when WSAStartup() has failed.
CBlockingSocketException::CBlockingSocketException(const char *pchMessage, int iError)
{
	m_strMessage = pchMessage;
	m_nError = iError;
}
