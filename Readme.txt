...
AppWizard has created this BlockingSocket library for you.  

This file contains a summary of what you will find in each of the files that
make up your BlockingSocket application.

/////////////////////////////////////////////////////////////////////////////

StdAfx.h, StdAfx.cpp
    These files are used to build a precompiled header (PCH) file
    named BlockingSocket.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "BlockingSocket.rc" and a "BlockingSocket.h" that 
